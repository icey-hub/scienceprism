...
**不得触碰**：`apps/backend/src/services/harnessRuntime/**`、`apps/backend/src/services/agentRoles/**`、`apps/backend/src/services/experimentRunner/**`、`package.json`、`package-lock.json`、`.gitignore`、`AGENTS.md`、`docs/agent-governance/{README,plan,requirements}.md`、`docs/agent-governance/subagents/**`、`tools/**`、`docs/assets/**`。
