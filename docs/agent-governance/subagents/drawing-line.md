...
| I-13 | `drawing-comparison.md` + 并排产物 | 9 维打分（渲染成功率、视觉质量、**复杂插画能力**、可编辑性、确定性、LaTeX 集成、离线可用、安装成本、CI 可验证性、中文支持）；产物提交 `docs/agent-governance/assets/diagrams/`；附截图证据 |
...
主方案与理由：
新增依赖命令：（原文，Lead 执行）
产物路径：（docs/agent-governance/assets/diagrams/...）
